...
const MostPopular = () => {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap place-items-center place-content-center bg-[#1b1d1f] w-4/5 h-4/3 xs:w-[96%] md:py-10 lg:my-44 md:my-28 sm:my-28 border border-transparent rounded-lg min-h-screen xs:my-20 px-10 xs:px-0 gap-10">
        {data ? (
          <div className="lg:rows-span-1 lg:col-span-3 md:rows-span-1 md:col-span-2 sm:mb-0 xs:mb-28 flex flex-wrap lg:px-10">
