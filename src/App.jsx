...
export function App() {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap place-items-center place-content-center bg-[#1b1d1f] w-4/5 h-4/3 md:py-10 lg:my-44 md:my-28 sm:my-28 border border-transparent rounded-lg min-h-screen ">
